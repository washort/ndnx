...
import org.ndnx.ndn.io.NDNAbstractOutputStream;
...
public class NDNVersionedOutputStreamTest implements NDNInterestHandler {
	
	static NDNTestHelper testHelper = new NDNTestHelper(NDNVersionedOutputStreamTest.class);
	...
	public static class Writer extends Thread {
		...
		protected NDNAbstractOutputStream _stream;
		protected int _fileLength;
		protected boolean _done = false;
		
		public Writer(NDNAbstractOutputStream stream, int fileLength) {
			_stream = stream;
	...
	public void testAddOutstandingInterest() throws Exception {
		...
		NDNVersionedInputStream vis = new NDNVersionedInputStream(streamName, readHandle);
	...
	public boolean handleInterest(Interest interest) {
		...
		NDNVersionedOutputStream vos = null;
		try {
			vos = new NDNVersionedOutputStream(interest.name(), writeHandle);
		} catch (IOException e) {
