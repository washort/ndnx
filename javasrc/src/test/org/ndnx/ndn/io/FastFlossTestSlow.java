...
public class FastFlossTestSlow {
	...
	public static NDNHandle readLibrary;
	public static NDNHandle writeLibrary;
	public static NDNTestHelper testHelper = new NDNTestHelper(FastFlossTestSlow.class);

	@BeforeClass
	public static void setUpBeforeClass() throws Exception {
		readLibrary = NDNHandle.open();
		writeLibrary = NDNHandle.open();
	}
	...
	public void fastFlossTest() {
		...
		try {
			...
			NDNVersionedOutputStream vos = new NDNVersionedOutputStream(ns, writeLibrary);
			streamData(vos);
		} catch (Exception e) {
	...
	public void streamData(NDNOutputStream outputStream) throws Exception {
		...
		NDNVersionedInputStream vis = new NDNVersionedInputStream(outputStream.getBaseName(), readLibrary);
		while (elapsed < FILE_SIZE) {
