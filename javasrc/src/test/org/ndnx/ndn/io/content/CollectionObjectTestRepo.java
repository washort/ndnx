 ...
 */
public class CollectionObjectTestRepo extends NDNTestBase {

	/**
	 * Handle naming for the test.
	 */
	static NDNTestHelper testHelper = new NDNTestHelper(CollectionObjectTestRepo.class);
	...
	public void testCollections() throws Exception {
		...
		NDNSerializableStringObject so = new NDNSerializableStringObject(nonCollectionName, "This is not a collection.", SaveType.REPOSITORY, putHandle);
		so.save();
		...
		NDNTime oldVersion = collection.getVersion();
