...
public class PublicKeyObjectTestRepo {
	...
	public void testUnversionedPublicKeyObject() throws Exception {
		...
		NDNOutputStream writeStream = new NDNOutputStream(unversionedName, handle);
		...
		NDNHandle otherHandle = NDNHandle.open();
		...
		PublicKeyObject testObject = new PublicKeyObject(firstSegment, NDNHandle.open());
