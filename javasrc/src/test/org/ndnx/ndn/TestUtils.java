...
public class TestUtils {
	 ...
	 * @throws IOException
	 */
	public static void checkObject(NDNHandle handle, NDNNetworkObject<?> cno) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void checkFile(NDNHandle handle, NDNAbstractInputStream stream) throws IOException {
		long startTime = System.currentTimeMillis();
		boolean ok = false;
		do {
