...
import static org.ndnx.ndn.protocol.ContentName.SEPARATOR;
import static org.ndnx.ndn.protocol.ContentName.fromNative;
...
public class ContentNameTest {
	...
	// Note that there is nothing invalid about these sequences in NDN names
	// since NDN names can include any values whatsoever, which is why we need
	...
	public String withScheme = "ndn:/test/briggs/test.txt";
	public String dotSlash = "ndn:/.../.%2e./...././.....///?...";
	public String dotSlashResolved = "ndn:/.../.../..../.....";
	...
	public String veryEscapedName = "ndn:/test/%C1.%77%00A%8C%B4B%8D%0A%AC%8E%14%8C%07%88%E4%E2%3Dn/%23%00%19/%C1.%76%00t%DF%F63/%FE%23/%C1.M.K%00%1E%90%EAh%E9%FB%AE%A3%9E%17F%20%CF%AB%A0%29%E9%DE%FAZ%DCA%FBZ%F5%DD%F5A%D2%D7%9F%D1/%FD%04%CB%F5qR%7B/%00";
	...
	public void testContentNameString() {
		...
		// string with ndn: scheme on front
	...
	public void testContentNameStringException() throws MalformedContentNameStringException {
		...
		parseWithException("ndn:a/relative/name");
		parseWithException("relative/no/scheme");
		// Not too many .. components
		parseWithException("ndn:/a/b/c/../../../..");
