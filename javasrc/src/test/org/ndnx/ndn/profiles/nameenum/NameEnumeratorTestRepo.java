...
public class NameEnumeratorTestRepo extends NDNTestBase implements BasicNameEnumeratorListener {
	...
	static NDNTestHelper testHelper = new NDNTestHelper(NameEnumeratorTestRepo.class);
	...
	public void testSpanningEnumeration() throws Exception {
		...
		NDNNameEnumerator ndnNE = new NDNNameEnumerator(getHandle, this);
		ndnNE.registerPrefix(baseName);
	...
	class DummyFilterListener implements NDNInterestHandler {
