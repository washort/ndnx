...
public class EnumeratedNameListTestRepo { 
	...
	static String prefix1StringError = "/park.com/csl/ndn/repositories";
	 ...
	 * */
	private ContentName addContentToRepo(ContentName name, NDNHandle handle) throws ConfigurationException, IOException {
		//method to load something to repo for testing
		NDNStringObject cso = 
			new NDNStringObject(name, Component.printNative(name.lastComponent()), SaveType.REPOSITORY, handle);
		cso.save();
