 ...
 */
public class NameEnumeratorTest extends NDNTestBase implements BasicNameEnumeratorListener{
	...
	public void testNameEnumerator() throws Exception {
		...
		//set up NDN libraries for testing
		setupNE();
	 ...
	 */
	public void setupNE(){
		putne = new NDNNameEnumerator(putHandle, this);
		getne = new NDNNameEnumerator(getHandle, this);
	}
