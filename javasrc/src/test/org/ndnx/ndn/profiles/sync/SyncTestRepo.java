...
public class SyncTestRepo extends NDNTestBase implements NDNSyncHandler, NDNContentHandler {
	
	public static NDNTestHelper testHelper = new NDNTestHelper(SyncTestRepo.class);
	...
	public void setUpNameSpace() {
		prefix = testHelper.getTestNamespace("ndnSyncTest");
	...
	public void testMultiSync() throws Exception {
		...
		NDNSyncHandler sh2 = new SyncHandler2();
		NDNSyncHandler sh3 = new SyncHandler3();
		slices.add(slice8);
	...
	public class SyncHandler2 implements NDNSyncHandler {
	...
	public class SyncHandler3 implements NDNSyncHandler {
