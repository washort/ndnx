...
import org.ndnx.ndn.profiles.security.access.group.PrincipalKeyDirectory;
...
public class KeyDirectoryTestRepo {
	...
	public static void setUpBeforeClass() throws Exception {
		// randomize names to minimize stateful effects of ndnd/repo caches.
	...
	public void testGetUnwrappedKeyGroupMember() throws Exception {
		...
		byte[] expectedKeyID = NDNDigestHelper.digest(AESSecretKey.getEncoded());
		kd2.waitForChildren();
		Thread.sleep(10000);
	...
	public void testAddWrappedKey() throws Exception {
		...
		wrappingPKID = NDNDigestHelper.digest(publicKey.getEncoded());
	...
	public void addWrappingKeyToACM() throws Exception {
		...
		byte[] publicKeyIdentifier = NDNDigestHelper.digest(wrappingKeyPair.getPublic().getEncoded());
	...
	public void testGetUnwrappedKeySuperseded() throws Exception {
		...
		byte[] expectedKeyID = NDNDigestHelper.digest(supersededAESSecretKey.getEncoded());
