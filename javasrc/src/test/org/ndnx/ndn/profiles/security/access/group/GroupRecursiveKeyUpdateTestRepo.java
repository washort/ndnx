...
/**
 * PD org.ndnx.ndn.test.profiles.security.access.group
 */
...
public class GroupRecursiveKeyUpdateTestRepo {
	...
	static NDNTime[] groupKeyCreationTime = new NDNTime[numberOfGroups];
	...
	public static void setUpBeforeClass() throws Exception {
		...
		NDNTestHelper testHelper = new NDNTestHelper(GroupRecursiveKeyUpdateTestRepo.class);
