...
package org.ndnx.ndn.profiles.security;
...
public class TestUserDataTestRepo {
   ...
   @Test
	public void testUserCreation() throws Exception {
		...
		NDNHandle userHandle = td.getHandleForUser(testUser);
		...
		for (String friendlyName: td.friendlyNames()){
			NDNHandle uHandle = td.getHandleForUser(friendlyName);
