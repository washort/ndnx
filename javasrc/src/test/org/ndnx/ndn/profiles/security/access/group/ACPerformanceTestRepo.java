...
public class ACPerformanceTestRepo {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		NDNTestHelper testHelper = new NDNTestHelper(ACPerformanceTestRepo.class);
		...
		GroupAccessControlManager.create(domainPrefix, profileName, rootACL, parameterizedNames, null, SaveType.REPOSITORY, NDNHandle.getHandle());
	...
	public void readFileAs(String userName) throws Exception {
		...
		try {
			NDNHandle handle = cua.getHandleForUser(userName);
