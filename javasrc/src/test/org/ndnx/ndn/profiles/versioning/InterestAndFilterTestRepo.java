...
import org.ndnx.ndn.profiles.versioning.VersioningHelper.TestFilterListener;
...
public class InterestAndFilterTestRepo {
	...
	protected NDNHandle _defaultHandle = null;
	protected NDNHandle _userHandle = null;
	...
	protected void sendObjects(ContentName name, int count, long pauseMsec) throws Exception {
		for(int i = 0; i < count; i++) {
			NDNStringObject so = new NDNStringObject(name, "Hello " + i, SaveType.LOCALREPOSITORY, _userHandle);
			so.save();
