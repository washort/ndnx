...
import org.ndnx.ndn.NDNLibraryTestHarness;
 ...
 */
public abstract class NDNFlowControlTestBase extends NDNTestBase {
	static protected NDNLibraryTestHarness _handle ;
	static protected NDNReader _reader;
	...
	protected NDNFlowControl fc = null;
