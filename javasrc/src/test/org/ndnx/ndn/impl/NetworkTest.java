...
/**
 * Test NDNNetworkManager.
 *
 * Note - this test requires ndnd to be running
 *
 */
public class NetworkTest extends NDNTestBase {
	...
	static NDNTestHelper testHelper = new NDNTestHelper(NetworkTest.class);
	...
	public void testNetworkManager() throws Exception {
		 ...
		 */
		NDNWriter writer = new NDNWriter(testPrefix, putHandle);
	...
	public void testNetworkManagerFixedPrefix() throws Exception {
		...
		NDNWriter writer = new NDNWriter(putHandle);
	...
	public void testNetworkManagerBackwards() throws Exception {
		...
		// fixing NDNWriter to do proper flow control.
	...
	class TestInterestHandler implements NDNInterestHandler {
	...
	class TestContentHandler implements NDNContentHandler {
	...
	class CancelTestInterestHandler implements NDNInterestHandler {
		...
		private CancelTestInterestHandler() throws IOException {
			writer = new NDNWriter(testName, putHandle);
			writer.disableFlowControl();
		}
	...
	class CancelTestContentHandler implements NDNContentHandler {
