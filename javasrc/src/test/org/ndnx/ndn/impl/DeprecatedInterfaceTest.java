...
import org.ndnx.ndn.NDNInterestListener;
...
public class DeprecatedInterfaceTest extends NDNTestBase implements NDNFilterListener, NDNInterestListener {
	...
	static NDNTestHelper testHelper = new NDNTestHelper(DeprecatedInterfaceTest.class);
