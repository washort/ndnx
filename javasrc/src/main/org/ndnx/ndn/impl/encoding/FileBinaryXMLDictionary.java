...
/**
 * Encapsulates the mapping from textual XML element and attribute names to the ndnb binary encoding
...
public class FileBinaryXMLDictionary implements XMLDictionary {
	...
	// Should not necessarily tie this to NDN...
	...
	public FileBinaryXMLDictionary() {
		try {
			...
			Log.warning(Log.FAC_ENCODING, "Cannot parse default NDN encoding dictionary: " + DEFAULT_DICTIONARY_RESNAME + ":" + 
					fe.getMessage());
		}
	}
