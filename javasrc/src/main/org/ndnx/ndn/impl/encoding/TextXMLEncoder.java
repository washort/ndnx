...
public class TextXMLEncoder extends GenericXMLEncoder implements XMLEncoder {
	...
	public void beginEncoding(OutputStream ostream) throws ContentEncodingException {
		...
		try {
    		...
    		_serializer.setPrefix(TextXMLCodec.NDN_PREFIX, TextXMLCodec.NDN_NAMESPACE);
	...
	public void writeDateTime(String tag, NDNTime dateTime) throws ContentEncodingException {
		writeElement(tag, TextXMLCodec.formatDateTime(dateTime));
	}

	public void writeDateTime(long tag, NDNTime dateTime) throws ContentEncodingException {
		writeElement(tag, TextXMLCodec.formatDateTime(dateTime));
	}
