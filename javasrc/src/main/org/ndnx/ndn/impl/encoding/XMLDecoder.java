 ...
 * or decoding content. The ndnb binary encoding supports only a number of simple types,
...
public interface XMLDecoder {
	 ...
	 * @param startTag expected start tag
	 * @return the decoded timestamp, using a quantized NDNTime
	 * @throws ContentDecodingException if startTag is not the next tag in the stream, or there is an error
	 * 		decoding the element or parsing the integer
	 */
	public NDNTime readDateTime(String startTag) throws ContentDecodingException;
