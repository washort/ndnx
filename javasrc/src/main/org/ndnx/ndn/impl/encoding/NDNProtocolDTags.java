 ...
 * so it cannot implement XMLDictionary.  Therefore, it is wrapped by NDNProtocolDictionary.
 */
public class NDNProtocolDTags {
	...
	public static final int NDNProtocolDataUnit = 17702112;
	public static final String NDNPROTOCOL_DATA_UNIT = "NDNProtocolDataUnit";
	...
	public static String tagToString(long tagVal) {
		...
		} else if (tagVal == NDNProtocolDataUnit) {
			return NDNPROTOCOL_DATA_UNIT;
		}
		return null;
	}
	...
	public static Long stringToTag(String tagName) {
		...
		if (NDNPROTOCOL_DATA_UNIT.equals(tagName)) {
			return (long)NDNProtocolDataUnit;
		}
		return null;
	}
}
