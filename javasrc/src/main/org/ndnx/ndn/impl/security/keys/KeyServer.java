...
/**
 * A small class to handle publishing keys to NDNx, without requiring a repository
...
public class KeyServer {
	...
	protected NDNFlowServer _keyServer = null;

	/**
	 * Constructor; uses existing handle.
	 * @param handle
	 */
	public KeyServer(NDNHandle handle) {
		_handle = handle;
	}

	public NDNHandle handle() { 
		return _handle; 
	}
	...
	public synchronized void initialize() throws IOException {
		...
		_keyServer = new NDNFlowServer(null, true, handle());
	}
