...
package org.ndnx.ndn.impl.security.crypto.util;
...
public class CryptoUtil {
	...
	public static byte [] generateCertID(Certificate cert) throws CertificateEncodingException {
		return generateCertID(NDNDigestHelper.DEFAULT_DIGEST_ALGORITHM, cert);
	}
	...
	public static byte [] generateKeyID(Key key) {
		return generateKeyID(NDNDigestHelper.DEFAULT_DIGEST_ALGORITHM, key);
	}
