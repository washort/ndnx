...
/** 
 * Helper class for generating signatures, supporting NDN-specific operations.
 */
public class NDNSignatureHelper extends SignatureHelper {
	...
	public static byte [] sign(String digestAlgorithm,
		...
		return SignatureHelper.sign(((null == digestAlgorithm) || (digestAlgorithm.length() == 0)) ?
				NDNDigestHelper.DEFAULT_DIGEST_ALGORITHM : digestAlgorithm, toBeSigned, signingKey);
	}
	...
	public static byte [] sign(String digestAlgorithm,
			   ...
			   PrivateKey signingKey) throws SignatureException,
			   	NoSuchAlgorithmException, InvalidKeyException {
		return SignatureHelper.sign(((null == digestAlgorithm) || (digestAlgorithm.length() == 0)) ?
					NDNDigestHelper.DEFAULT_DIGEST_ALGORITHM : digestAlgorithm, toBeSigneds, signingKey);
	}
	...
	public static boolean verify(
		...
		return SignatureHelper.verify(data, signature,
				((null == digestAlgorithm) || (digestAlgorithm.length() == 0)) ?
						NDNDigestHelper.DEFAULT_DIGEST_ALGORITHM : digestAlgorithm, verificationKey);
	}
