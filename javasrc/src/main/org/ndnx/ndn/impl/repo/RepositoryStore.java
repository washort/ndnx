...
import org.ndnx.ndn.impl.repo.RepositoryInfo.RepositoryInfoObject;
...
public interface RepositoryStore {
	...
	public static final ContentName REPO_NAMESPACE = new ContentName("ndn", "repository");
	 ...
	 * @param handle optional NDNHandle if caller wants to override the
	 * 	default connection/identity behavior of the repository -- this
	 * 	provides a KeyManager and handle for the repository to use to 
	 * 	obtain its keys and communicate with ndnd. If null, the repository
	...
	public void initialize(String repositoryRoot, File policyFile, 
						   ...
						   String nameSpace,
						   NDNHandle handle) throws RepositoryException;
	
	
	/**
	 * Get the handle the repository is using to communicate with ndnd.
