...
import static org.ndnx.ndn.profiles.CommandMarker.COMMAND_MARKER_REPO_START_WRITE;
 ...
 */
public class RepositoryFlowControl extends NDNFlowControl implements NDNContentHandler {
	...
	/**
	 * @param handle a NDNHandle - if null one is created
	 * @throws IOException if library is null and a new NDNHandle can't be created
	 */
	public RepositoryFlowControl(NDNHandle handle) throws IOException {
		super(handle);
	}
	 ...
	 * @throws IOException
	 */
	public RepositoryFlowControl(NDNHandle handle, boolean local) throws IOException {
		super(handle);
		localRepo = local;
	}
	 ...
	 * @param handle	a NDNHandle - if null one is created
	 * @throws IOException if handle is null and a new NDNHandle can't be created
	 */
	public RepositoryFlowControl(ContentName name, NDNHandle handle) throws IOException {
		super(name, handle);
	}
	 ...
	 * @throws IOException if handle is null and a new NDNHandle can't be created
	 */
	public RepositoryFlowControl(ContentName name, NDNHandle handle, boolean local) throws IOException {
		super(name, handle);
		localRepo = local;
	}
	 ...
	 * @see	NDNFlowControl
	 */
	public RepositoryFlowControl(ContentName name, NDNHandle handle, Shape shape) throws IOException {
		super(name, handle);
	}
	 ...
	 * @see	NDNFlowControl
	 */
	public RepositoryFlowControl(ContentName name, NDNHandle handle, Shape shape, boolean local) throws IOException {
		super(name, handle);
		localRepo = local;
	}
