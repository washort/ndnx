 ...
 * org.ndnx.ndn.LogDir or the environment variable NDN_LOG_DIR.	 To override the default
 * log level for whatever program you are running, set the system property org.ndnx.ndn.LogLevel.
 */
public class Log {
	...
	public static final String DEFAULT_LOG_FILE = "ndn_";
	 ...
	 */
	public static final String DEFAULT_LOG_LEVEL_PROPERTY = "org.ndnx.ndn.LogLevel";
	public static final String DEFAULT_LOG_LEVEL_ENV = "NDN_LOG_LEVEL";

	public static final String LOG_DIR_PROPERTY = "org.ndnx.ndn.LogDir";
	public static final String LOG_DIR_ENV = "NDN_LOG_DIR";
	...
	static {
		...
		//		_systemLogger.info("Initializing NDNX Logging");
		...
		for (int index = 0; index < handlers.length; index++) {
			...
			// TODO Enabling the following by default seems to cause ndn_repo to
...
//				System.out.println(String.format("Log.setLevel(%d, %s)", facility, l));
	...
	protected static void doLog(int facility, Level l, String msg, Object... params) {
		...
		// Use %.6f to get format same as ndnd, even though we only have
		// msec precision.
