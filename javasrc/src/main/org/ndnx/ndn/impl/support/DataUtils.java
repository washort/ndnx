...
/**
 * Miscellaneous utility routines for NDN, mostly data comparison and conversion.
 */
public final class DataUtils {
	...
	/**
	 * Perform a shortlex comparison of byte arrays in canonical NDN ordering.
	...
	/**
	 * @deprecated not used in NDNx, candidate for removal in future release.
	 * @param input
	 * @param lineLength
