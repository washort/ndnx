 ...
 *
 */
public abstract class BasicInterestListener implements NDNContentHandler {
	 ...
	 * expressed at the NDNHandle level or directly to
	 * a NDNRepository.
	 */
	protected NDNBase _interestProvider = null;
	
	public BasicInterestListener(NDNBase interestProvider) {
