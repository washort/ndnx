...
public class ndnlink {
	...
	public static void usage(String extraUsage) {
		System.err.println("usage: ndnlink " + extraUsage + "[-q] [-r] <link uri> <link target uri> [-as <pathToKeystore> [-name <friendly name]] (-q == quiet, -r == raw)");
	}
	/**
	 * @param args
	 */
	public static void main(String[] args) {
		...
		try {
			...
			Tuple<Integer, NDNHandle> tuple = null;
			...
			NDNHandle handle = ((null == tuple) || (null == tuple.second())) ? NDNHandle.getHandle() : tuple.second();
