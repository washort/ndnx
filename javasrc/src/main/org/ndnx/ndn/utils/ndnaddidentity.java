...
/**
 * Command line utility for modifying stored identity data. Use ndnwhoami to see what
 ...
 * allows only specification of NAME type key locators, as ndnx URIs. 
 * To find a keyid to use, use ndnwhoami.
 * 
 ...
 */
public class ndnaddidentity {

	public static void usage() {
		System.err.println("usage: ndnaddidentity [-q] keyid id_as_ndnx_uri [-as <pathToKeystore> [-name <friendly name]] (-q == quiet)");
	}
	/**
	 * @param args
	 */
