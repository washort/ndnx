...
public class ndnacl {
	...
	public static void usage(String extraUsage) {
		...
		System.out.println("ndnacl " + extraUsage + "[-as pathToKeystore] -show nodeName");
		System.out.println("ndnacl " + extraUsage + "[-as pathToKeystore] -edit nodeName principalName [none|r|rw|rw+]");
		System.out.println("ndnacl " + extraUsage + "[-as pathToKeystore] -init domain userNamespace groupNamespace principalName");
		System.exit(1);
	}
	...
	public static void showACL(String nodeName) {
		try{
			...
			GroupAccessControlManager acm = new GroupAccessControlManager(baseNode, groupStorage, userStorage, NDNHandle.open());
	...
	public static void initACL(String domain, String userNamespace, String groupNamespace, String principalName) {
		...
		try{
			...
			GroupAccessControlManager.create(domainPrefix, profileName, domainRootACL, parameterizedNames, null, SaveType.REPOSITORY, NDNHandle.open());
