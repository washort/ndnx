...
public class ShowTextDialog extends JDialog implements ActionListener{
	...
	public ShowTextDialog(ContentName name, NDNHandle h) {	
		...
		if (h==null) {
			System.err.println("NDNHandle is null, returning");
			return;
		}
	...
	/**
	 * Creates a NDNFileInputStream to write content to a NDN 
	 * writes the contents from a NDN to the editorPane
	 * 
	 *<p>
	 *@param fileName
	...
	public void displayText() throws IOException {
		try {
			...
			NDNFileInputStream fis = new NDNFileInputStream(contentname, this.handle);
