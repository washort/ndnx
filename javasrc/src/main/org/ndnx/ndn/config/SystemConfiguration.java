...
public class SystemConfiguration {
	...
	protected static final String NDN_PROTOCOL_PROPERTY = "org.ndnx.protocol";
	...
	public static final String AGENT_PROTOCOL_PROPERTY = "org.ndnx.agent.protocol";
	public static final String AGENT_PROTOCOL_ENVIRONMENT_VARIABLE = "NDN_AGENT_PROTOCOL";
	...
	public static final String NDN_EXIT_ON_NETWORK_ERROR_PROPERTY = "org.ndnx.ExitOnNetworkError";
	public static final String NDN_EXIT_ON_NETWORK_ERROR_ENVIRONMENT_VARIABLE = "NDN_EXIT_ON_NETERROR";
	 ...
	 * Default is 300ms
	 */
	protected static final String CHILD_WAIT_INTERVAL_PROPERTY = "org.ndnx.EnumList.WaitInterval";
	 ...
	 */
	protected static final String FC_TIMEOUT_PROPERTY = "org.ndnx.fc.timeout";
	 ...
	 */
	protected static final String FC_LOCALREPOSITORY_PROPERTY = "org.ndnx.fc.localrepository";
	...
	/**
	 * How long to wait for a service discovery timeout in NDNNetworkManager, in ms
	 *
	 * This should be longer than the interest timeout to permit at least one re-expression.
	 */
	protected static final String NDNDID_DISCOVERY_TIMEOUT_PROPERTY = "org.ndnx.ndndid.timeout";
	public final static int NDNDID_DISCOVERY_TIMEOUT_DEFAULT = 4200;
	public static int NDNDID_DISCOVERY_TIMEOUT = NDNDID_DISCOVERY_TIMEOUT_DEFAULT;

	/**
	 * Pipeline size for pipeline in NDNAbstractInputStream
	 * Default is 4
	 */
	protected static final String PIPELINE_SIZE_PROPERTY = "org.ndnx.PipelineSize";
	protected static final String PIPELINE_SIZE_ENV_VAR = "JAVA_PIPELINE_SIZE";
	public static int PIPELINE_SIZE = 4;

	/**
	 * Pipeline segment attempts for pipeline in NDNAbstractInputStream
	 * Default is 5
	 */
	protected static final String PIPELINE_ATTEMPTS_PROPERTY = "org.ndnx.PipelineAttempts";
	...
	/**
	 * Pipeline round trip time factor for pipeline in NDNAbstractInputStream
	 * Default is 2
	 */
	protected static final String PIPELINE_RTT_PROPERTY = "org.ndnx.PipelineRTTFactor";
	protected static final String PIPELINE_RTT_ENV_VAR = "JAVA_PIPELINE_RTTFACTOR";
	public static int PIPELINE_RTTFACTOR = 2;

	/**
	 * Pipeline stat printouts in NDNAbstractInputStream
	 * Default is off
	 */
	protected static final String PIPELINE_STATS_PROPERTY = "org.ndnx.PipelineStats";
	 ...
	 */
	protected static final String BLOCK_SIZE_PROPERTY = "ndn.lib.blocksize";
	protected static final String BLOCK_SIZE_ENV_VAR = "NDNX_BLOCKSIZE";
	 ...
	 */
	protected static final String OLD_HEADER_NAMES_PROPERTY = "org.ndnx.OldHeaderNames";
	protected static final String OLD_HEADER_NAMES_ENV_VAR = "NDNX_OLD_HEADER_NAMES";
	public static boolean OLD_HEADER_NAMES = true;


	/**
	 * Timeout used for communication with local 'ndnd' for control operations.
	 *
	 ...
	 * TODO - ndnop would properly be spelled ndndop
	 */
	protected static final String NDND_OP_TIMEOUT_PROPERTY = "org.ndnx.ndnop.timeout";
	protected final static String NDND_OP_TIMEOUT_ENV_VAR = "NDND_OP_TIMEOUT";
	public final static int NDND_OP_TIMEOUT_DEFAULT = 4200;
	public static int NDND_OP_TIMEOUT = NDND_OP_TIMEOUT_DEFAULT;

	/**
	 * System default timeout
	 */
	protected static final String NDNX_TIMEOUT_PROPERTY = "org.ndnx.default.timeout";
	protected final static String NDNX_TIMEOUT_ENV_VAR = "NDNX_TIMEOUT";
	public final static int NDNX_TIMEOUT_DEFAULT = EXTRA_LONG_TIMEOUT;

	/**
	 * GetLatestVersion attempt timeout.
	 * TODO  This timeout is set to MEDIUM_TIMEOUT to work around the problem
	 * in ndnd where some interests take >300ms (and sometimes longer, have seen periodic delays >800ms)
	 ...
	 */
	protected static final String GLV_ATTEMPT_TIMEOUT_PROPERTY = "org.ndnx.glv.attempt.timeout";
	 ...
	 */
	protected static final String SETTABLE_SHORT_TIMEOUT_PROPERTY = "org.ndnx.short.timeout";
	 ...
	 */
	protected static final String DUMP_NETMANAGER_STATS_PROPERTY = "org.ndnx.dump.netmanager.stats";
	protected final static String DUMP_NETMANAGER_STATS_ENV_VAR = "NDNX_DUMP_NETMANAGER_STATS";
	 ...
	 */
	protected static int _defaultTimeout = NDNX_TIMEOUT_DEFAULT;
...
//				if (!pAsString.equalsIgnoreCase(DEFAULT_PROTOCOL)) System.err.println("NDN agent protocol changed to " + pAsString + " per property");
				AGENT_PROTOCOL = p;
				found = true;
				break;
			}
		...
		try {
			EXIT_ON_NETWORK_ERROR = Boolean.parseBoolean(retrievePropertyOrEnvironmentVariable(NDN_EXIT_ON_NETWORK_ERROR_PROPERTY, NDN_EXIT_ON_NETWORK_ERROR_ENVIRONMENT_VARIABLE,
					Boolean.toString(DEFAULT_EXIT_ON_NETWORK_ERROR)));
//			System.err.println("NDND_OP_TIMEOUT = " + NDND_OP_TIMEOUT);
		...
		// Allow override of default pipeline size for NDNAbstractInputStream
		try {
		...
		// Allow override of default pipeline rtt multiplication factor for NDNAbstractInputStream
		try {
		...
		// Allow printing of pipeline stats in NDNAbstractInputStream
		...
		// Allow override of default ndndID discovery timeout.
		try {
			NDNDID_DISCOVERY_TIMEOUT = Integer.parseInt(System.getProperty(NDNDID_DISCOVERY_TIMEOUT_PROPERTY, Integer.toString(NDNDID_DISCOVERY_TIMEOUT_DEFAULT)));
			//			System.err.println("NDNDID_DISCOVERY_TIMEOUT = " + NDNDID_DISCOVERY_TIMEOUT);
		} catch (NumberFormatException e) {
			System.err.println("The ndndID discovery timeout must be an integer.");
			throw e;
		}
		...
		// Allow override of ndn default timeout.
		try {
			_defaultTimeout = Integer.parseInt(retrievePropertyOrEnvironmentVariable(NDNX_TIMEOUT_PROPERTY, NDNX_TIMEOUT_ENV_VAR, Integer.toString(NDNX_TIMEOUT_DEFAULT)));
			//			System.err.println("NDNX_TIMEOUT = " + NDNX_TIMEOUT);
		} catch (NumberFormatException e) {
			System.err.println("The ndnd default timeout must be an integer.");
			throw e;
		}

		// Allow override of ndnd op timeout.
		try {
			NDND_OP_TIMEOUT = Integer.parseInt(System.getProperty(NDND_OP_TIMEOUT_PROPERTY, Integer.toString(NDND_OP_TIMEOUT_DEFAULT)));
			//			System.err.println("NDND_OP_TIMEOUT = " + NDND_OP_TIMEOUT);
		} catch (NumberFormatException e) {
			System.err.println("The ndnd op timeout must be an integer.");
			throw e;
		}
	...
	public static void outputDebugData(ContentName name, byte [] data) {
		...
		try {	
			...
			byte [] contentDigest = NDNDigestHelper.digest(data);
	...
	public static void logObject(Level level, String message, ContentObject co) {
		try {
			byte [] coDigest = NDNDigestHelper.digest(co.encode());
			byte [] tbsDigest = NDNDigestHelper.digest(ContentObject.prepareContent(co.name(), co.signedInfo(), co.content()));
			Log.log(level, message + " name: {0} timestamp: {1} digest: {2}  tbs: {3}.",
					co.name(), co.signedInfo().getTimestamp(), NDNDigestHelper.printBytes(coDigest, DEBUG_RADIX),
					NDNDigestHelper.printBytes(tbsDigest, DEBUG_RADIX));
