 ...
 * stored in NDNx (writing and reading portions of that content); that content
...
public class KeyDirectory extends EnumeratedNameList {
	 ...
	 * @throws IOException
	 */
	public KeyDirectory(ContentName directoryName, NDNHandle handle)
	throws IOException {
	 ...
	 * @throws IOException
	 */
	public KeyDirectory(ContentName directoryName, boolean enumerate, NDNHandle handle)
	throws IOException {
	...
	public static void addSupersededByBlock(ContentName oldKeyVersionedNameToAddBlockTo, Key oldKeyToBeSuperseded,
			...
			Key supersedingKey, NDNHandle handle)
	throws ContentEncodingException, IOException, InvalidKeyException {
