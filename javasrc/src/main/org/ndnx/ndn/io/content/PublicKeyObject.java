...
/**
 * A NDNNetworkObject subclass specialized for reading and writing PublicKeys.
 * PublicKeys are Serializable. So we could use a subclass of NDNSerializableObject
 ...
 */
public class PublicKeyObject extends NDNNetworkObject<PublicKey> {
	 ...
	 * @throws IOException
	 */
	public PublicKeyObject(ContentName name, PublicKey data, SaveType saveType, NDNHandle handle) throws IOException {
	 ...
	 * @throws IOException
	 */
	public PublicKeyObject(ContentName name, NDNHandle handle) 
	 ...
	 * @throws IOException
	 */
	public PublicKeyObject(ContentObject firstBlock, NDNHandle handle) 
			throws ContentDecodingException, IOException {
	 ...
	 * @throws IOException
	 */
	public PublicKeyObject(ContentObject firstSegment, NDNFlowControl flowControl) 
					throws ContentDecodingException, IOException {
	 ...
	 * Copy constructor.
	 */
	public PublicKeyObject(NDNNetworkObject<? extends PublicKey> other) {
	...
	protected PublicKey readObjectImpl(InputStream input) throws ContentDecodingException, IOException {
		...
		try {
			...
			Log.severe("Blockname : " + ((NDNInputStream)input).currentSegmentName());
			throw new IOException("Cannot decode public key " + e.getClass().getName() + ": " + e.getMessage());
		} catch (InvalidKeySpecException e) {
			Log.warning("Cannot decode public key from block: " + ((NDNInputStream)input).currentSegmentName() + "  " + e.getClass().getName() + ": " + e.getMessage());
			throw new IOException("Cannot decode public key " + e.getClass().getName() + ": " + e.getMessage());
		}
	}
