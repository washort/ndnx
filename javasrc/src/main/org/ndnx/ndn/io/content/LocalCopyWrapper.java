 ...
 * is one connected directly to the same ndnd as the application; it may have 
...
public class LocalCopyWrapper implements UpdateListener {
	...
	final NDNNetworkObject<?> _netobj;
	final NDNHandle _handle;
	...
	public LocalCopyWrapper(NDNNetworkObject<?> obj) throws IOException {
		_netobj = obj;
	...
	public NDNNetworkObject<?> object() {
		return _netobj;
	}
	...
	public NDNTime getVersion() throws IOException {
