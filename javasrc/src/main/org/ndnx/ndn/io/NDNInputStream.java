...
/**
 * Perform sequential reads on any segmented NDN content, as if it
 ...
 * @author smetters
 */
public class NDNInputStream extends NDNAbstractInputStream {
	
	/**
	 * Set up an input stream to read segmented NDN content under a given name. Content is assumed
	 ...
	 */
	public NDNInputStream(ContentName baseName) throws IOException {
		this(baseName, null);
	}
	 ...
	 * @throws IOException Not currently thrown, will be thrown when constructors retrieve first block.
	 */
	public NDNInputStream(ContentName baseName, NDNHandle handle) throws IOException {
	 ...
	 * @throws IOException Not currently thrown, will be thrown when constructors retrieve first block.
	 */
	public NDNInputStream(ContentName baseName, PublisherPublicKeyDigest publisher, NDNHandle handle) 
    throws IOException {
	 ...
	 * @throws IOException Not currently thrown, will be thrown when constructors retrieve first block.
	 */
	public NDNInputStream(ContentName baseName, Long startingSegmentNumber, NDNHandle handle) throws IOException {
	 ...
	 * @throws IOException Not currently thrown, will be thrown when constructors retrieve first block.
	 */
	public NDNInputStream(ContentName baseName, Long startingSegmentNumber, PublisherPublicKeyDigest publisher,
	 ...
	 */
	public NDNInputStream(ContentName baseName, Long startingSegmentNumber, PublisherPublicKeyDigest publisher, 
                          ContentKeys keys, NDNHandle handle) throws IOException {
	 ...
	 */
	public NDNInputStream(ContentObject startingSegment, EnumSet<FlagTypes> flags, NDNHandle handle) throws IOException {
	 ...
	 * @throws IOException If startingSegment's name does not contain a valid segment number
	 */
	public NDNInputStream(ContentObject startingSegment, ContentKeys keys, EnumSet<FlagTypes> flags, NDNHandle handle) throws IOException {
