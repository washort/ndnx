...
/**
 * Deprecated - use NDNContentHandler instead
 * 
 * A listener used to receive callbacks when data arrives matching one of our
 * asynchronously-expressed Interests (expressed with NDNBase#expressInterest(Interest, NDNInterestListener)).
 ...
 */
@Deprecated
public interface NDNInterestListener extends NDNContentHandler {
