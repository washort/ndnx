...
import static org.ndnx.ndn.profiles.CommandMarker.COMMAND_MARKER_REPO_CHECKED_START_WRITE;
import static org.ndnx.ndn.profiles.SegmentationProfile.getSegmentNumberNameComponent;
...
import org.ndnx.ndn.io.NDNAbstractInputStream;
 ...
 * into a repository supported by classes in the org.ndnx.ndn.io 
 * package.
 * @author jthornto
 *
 */
public class RepositoryControl {
	 ...
	 * directly to the same ndnd as the given handle; such a repository
	 ...
	 */
	public static boolean localRepoSync(NDNHandle handle, NDNAbstractInputStream stream) throws IOException {
		boolean result;
	...
	/**
	 * Method to do the same as above but using NDNNetworkObjects instead of streams
	 * @param handle
	 * @param obj
	 * @param syncSigner
	 * @return
	 * @throws IOException
	 */
	public static boolean localRepoSync(NDNHandle handle, NDNNetworkObject<?> obj) throws IOException {
		boolean result;
	 ...
	 */
	static boolean internalRepoSync(NDNHandle handle, ContentName baseName, Long startingSegmentNumber, 
	...
	public static RepositoryInfo doLocalCheckedWrite(ContentName baseName,
			Long startingSegmentNumber, byte[] firstDigest, NDNHandle handle)
