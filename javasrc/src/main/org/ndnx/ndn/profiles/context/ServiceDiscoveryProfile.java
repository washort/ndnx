 ...
 */
public class ServiceDiscoveryProfile implements NDNProfile {
	...
	public static final String NDND_SERVICE_NAME = "ndnd";
	 ...
	 * @throws IOException 
	 */
	public static ArrayList<ContentObject> getLocalServiceKeys(String service, long timeout, NDNHandle handle) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static PublicKeyObject getLocalServiceKey(String service, long timeout, NDNHandle handle) throws IOException {
