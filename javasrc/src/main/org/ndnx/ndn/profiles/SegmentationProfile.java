 ...
 * Sequence/segment numbers occupy the final component of the NDN name
 ...
 *
 */
public class SegmentationProfile implements NDNProfile {
	...
	public static ContentObject getSegment(ContentName desiredContent, Long desiredSegmentNumber,
											...
											ContentVerifier verifier, NDNHandle handle) throws IOException {
	...
	public static ContentObject getLastSegment(ContentName name, PublisherPublicKeyDigest publisher, long timeout, ContentVerifier verifier, NDNHandle handle) throws IOException{
	 ...
	 *
	 */
	public static ContentObject getNextSegment(ContentName name, PublisherPublicKeyDigest publisher, long timeout, ContentVerifier verifier, NDNHandle handle) throws IOException {
		ContentName segmentName = null;
		ContentObject co = null;
