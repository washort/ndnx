...
import org.ndnx.ndn.protocol.ExcludeAny;
...
/**
 * Versions, when present, usually occupy the penultimate component of the NDN name,
 ...
 * a composite object are written as NDNNetworkObjects and automatically pick
 ...
 */
public class VersioningProfile implements NDNProfile {
	 ...
	 * @version should be a NDNTime toBinaryTimeAsLong() not getTime()
	 ...
	 */
	@Deprecated
	public static ContentName addVersion(ContentName name, NDNTime version) {
		if (null == version)
	...
	public static ContentName addVersion(ContentName name) {
		return new ContentName(name, NDNTime.now());
	}

	public static byte [] timeToVersionComponent(NDNTime version) {
	...
	public static String printAsVersionComponent(NDNTime version) {
	 ...
	 * first removes it.
	 */
	public static ContentName updateVersion(ContentName name, NDNTime version) {
	...
	public static ContentName updateVersion(ContentName name) {
		return updateVersion(name, NDNTime.now());
	}
	...
	public static NDNTime getVersionComponentAsTimestamp(byte [] versionComponent) {
	 ...
	 * @throws VersionMissingException
	 */
	public static NDNTime getLastVersionAsTimestamp(ContentName name) throws VersionMissingException {
		long time = getLastVersionAsLong(name);
		return NDNTime.fromBinaryTimeAsLong(time);
	}
	 ...
	 * @return
	 */
	public static NDNTime getLastVersionAsTimestampIfVersioned(ContentName name) {
	...
	public static NDNTime getTerminalVersionAsTimestampIfVersioned(ContentName name) {
	...
	public static NDNTime versionLongToTimestamp(long version) {
		return NDNTime.fromBinaryTimeAsLong(version);
	}
	 ...
	 * @param handle NDNHandle used to get the latest version
	 ...
	 * the latest of them. So if your ndnd cache has multiple versions, it will return
