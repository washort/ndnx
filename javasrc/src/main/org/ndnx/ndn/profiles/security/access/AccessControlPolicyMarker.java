...
import org.ndnx.ndn.profiles.namespace.PolicyMarker;
 ...
 * these markers is up to the policy and namespace; they are signed as regular NDNx data
...
public class AccessControlPolicyMarker extends GenericXMLEncodable implements PolicyMarker {
	...
	public static class AccessControlPolicyMarkerObject extends NDNEncodableObject<AccessControlPolicyMarker> {

		public AccessControlPolicyMarkerObject(ContentName name, NDNHandle handle) throws IOException {
			super(AccessControlPolicyMarker.class, true, name, handle);
		}

		public AccessControlPolicyMarkerObject(ContentName name, AccessControlPolicyMarker r, SaveType saveType, NDNHandle handle) throws IOException {
			super(AccessControlPolicyMarker.class, true, name, r, saveType, handle);
		}

		public AccessControlPolicyMarkerObject(ContentObject firstBlock, NDNHandle handle)
	...
	public static class ProfileName extends ContentName {
		...
		public long getElementLabel() {
			return NDNProtocolDTags.ProfileName;
		}
	}
	 ...
	 */
	public static void create(ContentName name, SaveType saveType, NDNHandle handle) throws IOException {
	...
	public void decode(XMLDecoder decoder) throws ContentDecodingException {
		...
		while (decoder.peekStartElement(NDNProtocolDTags.ParameterizedName)) {
			ParameterizedName pn = new ParameterizedName();
			pn.decode(decoder);
			_parameterizedNames.add(pn);
		}
		
		if (decoder.peekStartElement(NDNProtocolDTags.Parameters)) {
