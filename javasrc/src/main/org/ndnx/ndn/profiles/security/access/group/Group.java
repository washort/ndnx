 ...
 * public key is stored in NDN and is used to encrypt node keys (see NDNx
...
public class Group {
	 ...
	 * @param handle the NDN handle
	 * @param manager the group manager
	 * @throws IOException 
	 * @throws ContentDecodingException 
	 */
	public Group(ParameterizedName groupNamespace, String groupFriendlyName, NDNHandle handle,GroupManager manager) 
	 ...
	 * @throws ContentDecodingException 
	 */
	public Group(ContentName groupName, NDNHandle handle, GroupManager manager) throws ContentDecodingException, IOException {
	...
	Group(ParameterizedName groupNamespace, String groupFriendlyName, MembershipListObject members, 
					NDNHandle handle, GroupManager manager) 
	 ...
	 * @throws ContentDecodingException 
	 */
	public NDNTime membershipListVersion() throws ContentDecodingException, IOException {
	 ...
	 * @throws IOException
	 */
	public NDNTime publicKeyVersion() throws IOException {
