...
import org.ndnx.ndn.impl.security.crypto.KDFContentKeys;
...
import org.ndnx.ndn.profiles.namespace.NamespaceManager;
...
import org.ndnx.ndn.profiles.security.access.group.NodeKey;
 ...
 *   
 * * whenever any content is to be written using a NDNOutputStream (or subclass) or network object,
...
public abstract class AccessControlManager {
	...
	public static AccessControlManager 
			createAccessControlManager(AccessControlPolicyMarkerObject policyInformation, NDNHandle handle) 
	...
	public static AccessControlManager createAccessControlManager(ContentName accessControlPolicyName,
				NDNHandle handle) throws ContentNotReadyException, ContentGoneException, ErrorStateException, ConfigurationException, InstantiationException, IllegalAccessException, IOException {
	...
	public abstract boolean initialize(AccessControlPolicyMarkerObject policyInformation, NDNHandle handle) 
				throws IOException;
	...
	public NDNHandle handle() { return _handle; }
	 ...
	 * @param library NDN Library instance to use for any network operations.
	 ...
	 */
	public static ContentKeys keysForInput(ContentName name, PublisherPublicKeyDigest publisher, NDNHandle handle)
	throws IOException {
	 ...
	 * Called by the NDNOutputStream subclasses to get encryption keys for specific content
	 * segments. 
	 * @param name
	 * @param publisher
	 ...
	 * @throws IOException
	 */
	public static ContentKeys keysForOutput(ContentName name, PublisherPublicKeyDigest publisher, ContentType contentType, NDNHandle handle)
	throws IOException {
	 ...
	 * @throws IOException
	 */
	public static AccessControlManager findACM(ContentName name, NDNHandle handle)  
					throws IOException {
	 ...
	 * @throws IOException
	 */
	public static AccessControlManager loadAccessControlManagerForNamespace(ContentName namespace, NDNHandle handle) 
	 ...
	 */
	public boolean isProtectedContent(ContentName name, PublisherPublicKeyDigest publisher, ContentType contentType, NDNHandle hande) {
