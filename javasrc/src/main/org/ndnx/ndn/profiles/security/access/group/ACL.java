...
/**
 * This class represents an Access Control List (ACLs) for NDN content, for use with
...
public class ACL extends Collection {
	...
	/**
	 * ACL NDN objects; as it only makes sense right now to
	 * operate on ACLs in repositories, it writes all data to repositories..
	 *
	 */
	public static class ACLObject extends NDNEncodableObject<ACL> {
		 ...
		 * @throws IOException
		 */
		public ACLObject(ContentName name, ACL data, NDNHandle handle) throws IOException {
		 ...
		 */
		public ACLObject(ContentName name, NDNHandle handle) 
		...
		public ACLObject(ContentObject firstBlock, NDNHandle handle) 
				throws ContentDecodingException, IOException {
		...
		public ACLObject(ContentObject firstBlock, NDNFlowControl flowControl)
				throws ContentDecodingException, IOException {
