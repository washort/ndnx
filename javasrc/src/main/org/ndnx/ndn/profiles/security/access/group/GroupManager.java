...
public class GroupManager {
	...
	public GroupManager(GroupAccessControlManager accessManager,
						ParameterizedName groupStorage, NDNHandle handle) {
		_handle = handle;
	 ...
	 * @return
	 */
	GroupManager(GroupAccessControlManager accessManager, NDNHandle handle) throws IOException {
		_handle = handle;
		_accessManager = accessManager;
	...
	public boolean groupExists(String groupFriendlyName, long timeout) throws IOException {
		...
		return (null != NDNReader.isAnyContentAvailable(publicKeyName, null, timeout, _handle));
	}
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	public Key getGroupPrivateKey(String groupFriendlyName, NDNTime privateKeyVersion) 
