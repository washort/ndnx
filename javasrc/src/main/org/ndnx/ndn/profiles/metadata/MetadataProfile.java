 ...
 */
public class MetadataProfile implements NDNProfile {
	...
	public static final byte [] OLD_METADATA_NAMESPACE = 
		(NDNProfile.MARKER + "meta" + NDNProfile.MARKER).getBytes();
	...
	public static ContentName getLatestVersion(ContentName baseName, MetaNamer namer, ContentName metaName,
		...
		//NDNInputStream checker = new NDNInputStream(baseName, handle);
		//if (null == checker)
		//	return null;
