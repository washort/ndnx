...
public class ContentName extends GenericXMLEncodable implements XMLEncodable, Comparable<ContentName>, Serializable, ContentNameProvider, Iterable<byte []> {
	 ...
	 */
	public static final String ORIGINAL_SCHEME = "ndn:";
	 ...
	 * A NDN <code>ContentName</code> consists of a sequence of binary components
	 ...
	 * <p>
	 * The canonical String representation of a NDN <code>ContentName</code> is a
	 ...
	 * canonical NDN string representation to encode all possible NDN names.
	 * <p>
	 ...
	 * <p>
	 * The URI must begin with either the "/" delimiter or the scheme specification "ndn:"
	 ...
	 * have "..." appended.  This is intended to be consistent with the NDN C
	...
	public void decode(XMLDecoder decoder) throws ContentDecodingException {
		...
		while (decoder.peekStartElement(NDNProtocolDTags.Component))
			components.add(decoder.readBinaryElement(NDNProtocolDTags.Component));
	...
	public void encode(XMLEncoder encoder) throws ContentEncodingException {
		...
		for (int i=0; i < _components.length; ++i) {
			encoder.writeElement(NDNProtocolDTags.Component, _components[i]);
		}
