...
public class Exclude extends GenericXMLEncodable implements XMLEncodable,
	...
	public void decode(XMLDecoder decoder) throws ContentDecodingException {
		...
		synchronized (_values) {
			boolean component;
			boolean any = false;
			while ((component = decoder.peekStartElement(NDNProtocolDTags.Component)) || 
					(any = decoder.peekStartElement(NDNProtocolDTags.Any)) ||
						decoder.peekStartElement(NDNProtocolDTags.Bloom)) {
	...
	@Override
	public long getElementLabel() { return NDNProtocolDTags.Exclude; }
