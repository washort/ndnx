...
package org.ndnx.ndn.test.io.content;
...
import org.ndnx.ndn.test.NDNTestHelper;
 ...
 * to NDN using WrappedKeyObjects. This expanded test requires that unlimited
...
public class ExpandedWrappedKeyTest {
	 ...
	 */
	static NDNTestHelper testHelper = new NDNTestHelper(ExpandedPublicKeyObjectTestRepo.class);
