...
package org.ndnx.ndn.apps.examples.ndnb;
...
public class StringBinaryVector extends GenericXMLEncodable {
	...
	public void decode(XMLDecoder decoder) throws ContentDecodingException {
		...
		while (decoder.peekStartElement(NDNProtocolDTags.Interest) || decoder.peekStartElement(NDNProtocolDTags.Name)) {
			if (decoder.peekStartElement(NDNProtocolDTags.Interest)) {
				Interest interest = new Interest();
				interest.decode(decoder);
				interests.add(interest);
			} else if (decoder.peekStartElement(NDNProtocolDTags.Name)) {
