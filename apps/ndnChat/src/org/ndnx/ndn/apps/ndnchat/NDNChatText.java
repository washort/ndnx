...
/**
 * A text-based interface to NDNChat.
 * 
 ...
 * the INPUT line.
 */
public class NDNChatText implements Runnable, NDNChatCallback {
	...
	protected NDNChatText(String namespace) throws MalformedContentNameStringException {
		_chat = new NDNChatNet(this, namespace);
		_thd = new Thread(this, "NDNChatText");
	}
