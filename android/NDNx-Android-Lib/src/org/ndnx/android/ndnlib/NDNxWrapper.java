...
/**
 * Wrap up the AIDL calls to a NDNxService.  Hide all the ugly RPC from
 * the user of the services.
 */
public abstract class NDNxWrapper {
	public String TAG = "NDNxWrapper";
	...
	public NDNxWrapper(Context ctx){
		_ctx = ctx;
	}
	
	public void setCallback(NDNxServiceCallback scb){
		_scb = scb;
	}
	
	protected void issueCallback(){
		_scb.newNDNxStatus(status);
	}
	...
	protected void bindService(){
		sConn = new ServiceConnection(){
			public void onServiceConnected(ComponentName name, IBinder binder) {
				...
				synchronized(iServiceLock) {
					iService = INDNxService.Stub.asInterface(binder);
					try {
