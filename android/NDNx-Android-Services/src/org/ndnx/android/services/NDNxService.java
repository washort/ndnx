...
import org.ndnx.android.ndnlib.INDNxService;
import org.ndnx.android.ndnlib.IStatusCallback;
 ...
 */
public abstract class NDNxService extends Service implements Runnable {
	protected String TAG = "NDNxService";
	...
	protected SharedPreferences mNDNxServicePrefs;

	private final INDNxService.Stub serviceBinder = new INDNxService.Stub() {
	...
	public void onCreate(){
		...
		// Init Preferences
		mNDNxServicePrefs = this.getSharedPreferences("ndnxserviceprefs", MODE_WORLD_READABLE);
	...
	private void showNotification() {
        ...
        Notification notification = new Notification(R.drawable.ndnxlogo48px, text, System.currentTimeMillis());
