...
/**
 * Initial screen to make configuration choices.  No NDNx code here.
 * After user presses Connect button, we startup the ChatScreen UI and
 * exit this screen.
 * 
 * The default "handle" (NDNX user name) is the device's phone number.
 * If we cannot get a phone number, we use the name "Android".
 */
public final class NdnxChatMain extends Activity implements OnClickListener{
	protected final static String TAG = "ndnchat.StartScreen";
	
	/** Called when the activity is first created. */
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.ndnchat_settings);
	...
	// ==========================================================
	// Internal stuff
	private static final String PREFS_NAME="ndnChatPrefs";
